...
def main():
    ...
    path_model = args.path_write_data + 'model'
    ...
    if os.path.isdir(args.path_write_data + 'model/sparkdf.json'):
        print('The file data for topic modelling already exists.')
    else:
        data_for_tm.write.option('compression', 'gzip').json(args.path_write_data + 'model/sparkdf.json')
