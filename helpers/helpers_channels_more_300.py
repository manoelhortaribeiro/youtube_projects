...
def dict_occurent_users():
    occurent_users = {}
    with open("/dlabdata1/youtube_large/jouven/channels_more_300/duplicate_users.pkl",'rb') as f:
...
def video_id_to_channel_id():
    return pd.read_pickle("/dlabdata1/youtube_large/jouven/channels_more_300/video_to_channel_mapping_filtered.pkl")
